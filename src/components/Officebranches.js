...
//         {/* <h2 className="text-2xl font-semibold mb-4" >Our Office Branches</h2> */}
//         <h2 className='lg:text-3xl text-2xl text-center  font-semibold mb-3 '>Visit <span className='text-textteal'>Our Office</span></h2>

//         <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:text-2x1 text-center">
//           {branches.map(branch => (
