      ...
      <div className="grid grid-cols-1  gap-4 lg:grid-cols-2 lg:gap-8">
        <div className="lg:h-auto h-64 ">
          <Carousel>
            <img
              ...
              src="https://files.tofugu.com/articles/japanese/2022-07-19-what-is-the-jlpt/header-5120x.jpg"
              alt="Study in Japan"
            />
            <img
              className="object-cover w-full h-full"
              src="https://files.tofugu.com/articles/japanese/2022-07-19-what-is-the-jlpt/jlpt-certificate.jpg"
              alt="Study in UK"
            />
        ...
        <div className="p-4">
          <h2 className="mt-4 text-xl lg:text-3xl font-semibold mb-8">
           Japanese <span className="text-textteal">Language Proficiency</span> Test
          </h2>
