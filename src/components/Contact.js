...
//   return (
//     <>
//       <div className="max-w-md  px-4 mb-10 ml-40">
//         <div>
...
//       <div className="max-w-md mx-auto mb-50">
//         <iframe
//           width="100%"
//           height="300"
//           frameBorder="0"
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow flex justify-center items-start">
        ...
        <div className="max-w-md px-4 mb-10">
          <div>
            <img
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="bg-textteal text-white px-4 py-2 rounded-md hover:bg-blue-600"
            >
              Submit
            </button>
          </form>
        ...
        <div className="max-w-md  mb-10 ml-40">
          <iframe
            width="180%"
            height="550"
            frameBorder="0"
